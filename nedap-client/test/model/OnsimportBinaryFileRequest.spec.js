...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OnsimportBinaryFileRequest', function() {
      beforeEach(function() {
        instance = new NedapOnsApi.OnsimportBinaryFileRequest();
      });

      it('should create an instance of OnsimportBinaryFileRequest', function() {
        // TODO: update the code to test OnsimportBinaryFileRequest
        expect(instance).to.be.a(NedapOnsApi.OnsimportBinaryFileRequest);
      });
