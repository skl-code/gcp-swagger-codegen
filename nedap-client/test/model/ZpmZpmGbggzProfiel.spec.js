...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ZpmZpmGbggzProfiel', function() {
      beforeEach(function() {
        instance = new NedapOnsApi.ZpmZpmGbggzProfiel();
      });

      it('should create an instance of ZpmZpmGbggzProfiel', function() {
        // TODO: update the code to test ZpmZpmGbggzProfiel
        expect(instance).to.be.a(NedapOnsApi.ZpmZpmGbggzProfiel);
      });
