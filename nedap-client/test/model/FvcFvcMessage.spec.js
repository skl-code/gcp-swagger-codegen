...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FvcFvcMessage', function() {
      beforeEach(function() {
        instance = new NedapOnsApi.FvcFvcMessage();
      });

      it('should create an instance of FvcFvcMessage', function() {
        // TODO: update the code to test FvcFvcMessage
        expect(instance).to.be.a(NedapOnsApi.FvcFvcMessage);
      });
