...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MiloApp', function() {
      beforeEach(function() {
        instance = new NedapOnsApi.MiloApp();
      });

      it('should create an instance of MiloApp', function() {
        // TODO: update the code to test MiloApp
        expect(instance).to.be.a(NedapOnsApi.MiloApp);
      });
