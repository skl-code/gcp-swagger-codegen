...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DossierMedicalInvoluntaryCareLegalGround', function() {
      beforeEach(function() {
        instance = new NedapOnsApi.DossierMedicalInvoluntaryCareLegalGround();
      });

      it('should create an instance of DossierMedicalInvoluntaryCareLegalGround', function() {
        // TODO: update the code to test DossierMedicalInvoluntaryCareLegalGround
        expect(instance).to.be.a(NedapOnsApi.DossierMedicalInvoluntaryCareLegalGround);
      });
