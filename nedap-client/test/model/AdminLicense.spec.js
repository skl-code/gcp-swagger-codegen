...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AdminLicense', function() {
      beforeEach(function() {
        instance = new NedapOnsApi.AdminLicense();
      });

      it('should create an instance of AdminLicense', function() {
        // TODO: update the code to test AdminLicense
        expect(instance).to.be.a(NedapOnsApi.AdminLicense);
      });
