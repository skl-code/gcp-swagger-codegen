...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CarepathTemplate', function() {
      beforeEach(function() {
        instance = new NedapOnsApi.CarepathTemplate();
      });

      it('should create an instance of CarepathTemplate', function() {
        // TODO: update the code to test CarepathTemplate
        expect(instance).to.be.a(NedapOnsApi.CarepathTemplate);
      });
