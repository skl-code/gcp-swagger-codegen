...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CaretechStatus', function() {
      beforeEach(function() {
        instance = NedapOnsApi.CaretechStatus;
      });

      it('should create an instance of CaretechStatus', function() {
        // TODO: update the code to test CaretechStatus
        expect(instance).to.be.a('object');
      });

      it('should have the property REQUEST', function() {
