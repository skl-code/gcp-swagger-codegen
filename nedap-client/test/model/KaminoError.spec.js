...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('KaminoError', function() {
      beforeEach(function() {
        instance = new NedapOnsApi.KaminoError();
      });

      it('should create an instance of KaminoError', function() {
        // TODO: update the code to test KaminoError
        expect(instance).to.be.a(NedapOnsApi.KaminoError);
      });
