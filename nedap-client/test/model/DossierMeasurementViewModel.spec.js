...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DossierMeasurementViewModel', function() {
      beforeEach(function() {
        instance = new NedapOnsApi.DossierMeasurementViewModel();
      });

      it('should create an instance of DossierMeasurementViewModel', function() {
        // TODO: update the code to test DossierMeasurementViewModel
        expect(instance).to.be.a(NedapOnsApi.DossierMeasurementViewModel);
      });
