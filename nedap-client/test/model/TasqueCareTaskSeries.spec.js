...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TasqueCareTaskSeries', function() {
      beforeEach(function() {
        instance = new NedapOnsApi.TasqueCareTaskSeries();
      });

      it('should create an instance of TasqueCareTaskSeries', function() {
        // TODO: update the code to test TasqueCareTaskSeries
        expect(instance).to.be.a(NedapOnsApi.TasqueCareTaskSeries);
      });
