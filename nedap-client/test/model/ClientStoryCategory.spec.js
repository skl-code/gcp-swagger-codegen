...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ClientStoryCategory', function() {
      beforeEach(function() {
        instance = new NedapOnsApi.ClientStoryCategory();
      });

      it('should create an instance of ClientStoryCategory', function() {
        // TODO: update the code to test ClientStoryCategory
        expect(instance).to.be.a(NedapOnsApi.ClientStoryCategory);
      });
