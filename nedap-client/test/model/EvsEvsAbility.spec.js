...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EvsEvsAbility', function() {
      beforeEach(function() {
        instance = new NedapOnsApi.EvsEvsAbility();
      });

      it('should create an instance of EvsEvsAbility', function() {
        // TODO: update the code to test EvsEvsAbility
        expect(instance).to.be.a(NedapOnsApi.EvsEvsAbility);
      });
